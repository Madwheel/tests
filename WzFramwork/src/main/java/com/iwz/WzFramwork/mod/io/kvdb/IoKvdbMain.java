...
public class IoKvdbMain extends ModMain implements IIoKvdb {
    ...
    private static IoKvdbMain mIoKvdbMain = null;
    ...
    public void born() {
        ...
        try {
            ...
            mGlobalDb = DBFactory.open(WzFramworkApplication.getmContext(), "kv.global", kryo);
    ...
    public void put(String key, Object object) throws Exception {
        mGlobalDb.put(key, object);
    }

    public String get(String key) throws Exception {
        return mGlobalDb.get(key);
    }

    public <T> T getObject(String key, Class<T> className) throws Exception {
        return mGlobalDb.getObject(key, className);
    }
}
